        ...
        <div className="container mx-auto max-w-6xl px-6 py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-2">
              ...
              <span className="font-bold text-sm">Solcraft</span>
              <span className="text-sm text-muted-foreground/70 ml-2">
                • AI-Powered Solana Crafting
              </span>
            </div>
      ...
      <main className="container mx-auto max-w-6xl px-6 py-16">
              ...
              <div className="space-y-4">
                <div className="flex gap-3 mb-2">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">
                      Start with zero Solana knowledge. We teach you as we
                      build.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">
                      Each agent encodes Solana best practices. Security
                      patterns, gas optimization, proper PDA derivation - all
                      built in.
                    </p>
                  </div>
                </div>
        ...
        <section id="waitlist" className="mb-24">
          <div className="border border-border/50 p-12">
            ...
            <p className="text-lg text-muted-foreground mb-6">
              Get notified when we launch beta. Early adopters get free access
              to premium features.
            </p>
            {!isSubmitted ? (
